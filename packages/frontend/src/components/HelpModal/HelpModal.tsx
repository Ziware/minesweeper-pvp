          ...
          <section>
            ...
            <div className={styles.phase}>
              ...
              <p>
                ...
                (<kbd>Ctrl+Click</kbd>), если у вас есть разминирования в запасе.
                В начале игры у каждого игрока <strong>1 разминирование</strong>.
                После каждых <strong>5 совместных ходов</strong> (после 5-го, 10-го, 15-го хода
                и т. д.) оба игрока получают <strong>+1 разминирование</strong> в свой запас.
                Так как первым ходит красный, право воспользоваться новой добавкой
                первым получает синий. Запас разминирований переходит между ходами и
                расходуется только при использовании.
              </p>
              <p>
